...
exports.ModenaUniversalRegistry = exports.ModenaUniversalPublishRequest = void 0;
...
var ModenaUniversalPublishRequest = /** @class */ (function (_super) {
    __extends(ModenaUniversalPublishRequest, _super);
    function ModenaUniversalPublishRequest() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return ModenaUniversalPublishRequest;
}(publish_did_request_1.PublishDIDRequest));
exports.ModenaUniversalPublishRequest = ModenaUniversalPublishRequest;
var ModenaUniversalRegistry = /** @class */ (function (_super) {
    __extends(ModenaUniversalRegistry, _super);
    function ModenaUniversalRegistry() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ModenaUniversalRegistry.prototype.getSupportedDidMethods = function (universalRegistryUrl) {
        return __awaiter(this, void 0, void 0, function () {
            var options, response, msg, body;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, node_fetch_1.default)("".concat(universalRegistryUrl, "/mappings"), options)];
                    case 1:
                        response = _a.sent();
                    ...
                    case 4:
                        body = _a.sent();
                        return [2 /*return*/, body.list.map(function (x) { return x.pattern; })];
                }
            });
        });
    };
    ModenaUniversalRegistry.prototype.publishDID = function (request) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!request.universalResolverURL)
                            throw new Error("universalResolverURL is required when did method is defined");
                        input = {
                        ...
                        url = "".concat(request.universalResolverURL, "/create");
                        headers = {
                            "Content-Type": "application/json",
                        };
    ...
    ModenaUniversalRegistry.prototype.updateDID = function (params) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    return ModenaUniversalRegistry;
}(modena_registry_service_1.ModenaRegistryBase));
exports.ModenaUniversalRegistry = ModenaUniversalRegistry;
//# sourceMappingURL=modena-universal-registry.service.js.map