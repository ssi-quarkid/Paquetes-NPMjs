...
class TopicBroadcaster {
    ...
    constructor(topics, config = {}) {
        ...
        this.topics = topics;
        this.networkPreset = (_a = config.networkPreset) !== null && _a !== void 0 ? _a : 'mainnet';
        this.facilitator = (_b = config.facilitator) !== null && _b !== void 0 ? _b : new HTTPSOverlayBroadcastFacilitator(undefined, this.networkPreset === 'local');
        this.resolver = (_c = config.resolver) !== null && _c !== void 0 ? _c : new LookupResolver_js_1.default({ networkPreset: this.networkPreset });
        this.requireAcknowledgmentFromAllHostsForTopics =
            (_d = config.requireAcknowledgmentFromAllHostsForTopics) !== null && _d !== void 0 ? _d : [];
        this.requireAcknowledgmentFromAnyHostForTopics =
            (_e = config.requireAcknowledgmentFromAnyHostForTopics) !== null && _e !== void 0 ? _e : 'all';
        this.requireAcknowledgmentFromSpecificHostsForTopics =
            (_f = config.requireAcknowledgmentFromSpecificHostsForTopics) !== null && _f !== void 0 ? _f : {};
    }
    /**
    ...
    async broadcast(tx) {
        ...
        for (const result of successfulHosts) {
            ...
            for (const [topic, instructions] of Object.entries(steak)) {
                ...
                if ((outputsToAdmit === null || outputsToAdmit === void 0 ? void 0 : outputsToAdmit.length) > 0 ||
                    (coinsToRetain === null || coinsToRetain === void 0 ? void 0 : coinsToRetain.length) > 0 ||
                    (coinsRemoved === null || coinsRemoved === void 0 ? void 0 : coinsRemoved.length) > 0) {
