...
class LookupResolver {
    constructor(config = {}) {
        ...
        this.facilitator = (_b = config.facilitator) !== null && _b !== void 0 ? _b : new HTTPSOverlayLookupFacilitator(undefined, this.networkPreset === 'local');
        this.slapTrackers = (_c = config.slapTrackers) !== null && _c !== void 0 ? _c : (this.networkPreset === 'mainnet' ? exports.DEFAULT_SLAP_TRACKERS : exports.DEFAULT_TESTNET_SLAP_TRACKERS);
        this.hostOverrides = (_d = config.hostOverrides) !== null && _d !== void 0 ? _d : {};
        this.additionalHosts = (_e = config.additionalHosts) !== null && _e !== void 0 ? _e : {};
    }
    /**
    ...
    async query(question, timeout) {
        ...
        if (((_a = this.additionalHosts[question.service]) === null || _a === void 0 ? void 0 : _a.length) > 0) {
            competentHosts = [
                ...competentHosts,
        ...
        for (const response of successfulResponses) {
            ...
            try {
                for (const output of response.outputs) {
                    try {
                        const txId = String(index_js_1.Transaction.fromBEEF(output.beef).id('hex'));
