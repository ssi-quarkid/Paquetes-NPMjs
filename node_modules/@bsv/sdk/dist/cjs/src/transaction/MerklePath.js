...
class MerklePath {
    ...
    toBinary() {
        ...
        for (let level = 0; level < treeHeight; level++) {
            ...
            for (const leaf of this.path[level]) {
                ...
                let flags = 0;
                if ((leaf === null || leaf === void 0 ? void 0 : leaf.duplicate) === true) {
                    flags |= 1;
                }
                if ((leaf === null || leaf === void 0 ? void 0 : leaf.txid) !== undefined && leaf.txid !== null) {
                    flags |= 2;
                }
    ...
    computeRoot(txid) {
        ...
        if (typeof txid !== 'string') {
            const foundLeaf = this.path[0].find((leaf) => Boolean(leaf === null || leaf === void 0 ? void 0 : leaf.hash));
        ...
        if (typeof index !== 'number') {
            throw new Error(`This proof does not contain the txid: ${txid !== null && txid !== void 0 ? txid : 'undefined'}`);
        }
        ...
        for (let height = 0; height < this.path.length; height++) {
            ...
            if (leaf.duplicate === true) {
                workingHash = hash((workingHash !== null && workingHash !== void 0 ? workingHash : '') + (workingHash !== null && workingHash !== void 0 ? workingHash : ''));
            }
            else if (offset % 2 !== 0) {
                workingHash = hash(((_a = leaf.hash) !== null && _a !== void 0 ? _a : '') + (workingHash !== null && workingHash !== void 0 ? workingHash : ''));
            }
            else {
                workingHash = hash((workingHash !== null && workingHash !== void 0 ? workingHash : '') + ((_b = leaf.hash) !== null && _b !== void 0 ? _b : ''));
            }
        }
        return workingHash;
    }
    ...
    findOrComputeLeaf(height, offset) {
        ...
        if (leaf1.duplicate === true) {
            ...
            workinghash = hash(((_a = leaf1.hash) !== null && _a !== void 0 ? _a : '') + ((_b = leaf0.hash) !== null && _b !== void 0 ? _b : ''));
        }
        leaf = {
            offset,
            hash: workinghash
        ...
        for (let h = 0; h < this.path.length; h++) {
            ...
            for (let l = 0; l < other.path[h].length; l++) {
                if (combinedPath[h].find((leaf) => leaf.offset === other.path[h][l].offset) === undefined) {
                    ...
                    if (((_a = other.path[h][l]) === null || _a === void 0 ? void 0 : _a.txid) !== undefined && ((_b = other.path[h][l]) === null || _b === void 0 ? void 0 : _b.txid) !== null) {
