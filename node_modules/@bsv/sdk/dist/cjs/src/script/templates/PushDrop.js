...
class PushDrop {
    ...
    static decode(script) {
        ...
        for (let i = 2; i < script.chunks.length; i++) {
            const nextOpcode = (_a = script.chunks[i + 1]) === null || _a === void 0 ? void 0 : _a.op; // ✅ Prevent accessing `op` from `undefined`
            let chunk = (_b = script.chunks[i].data) !== null && _b !== void 0 ? _b : []; // ✅ Ensure `chunk` is always `number[]`
            if (chunk.length === 0) {
    ...
    unlock(protocolID, keyID, counterparty, signOutputs = 'all', anyoneCanPay = false, sourceSatoshis, lockingScript) {
        return {
            sign: async (tx, inputIndex) => {
                ...
                sourceSatoshis || (sourceSatoshis = (_c = input.sourceTransaction) === null || _c === void 0 ? void 0 : _c.outputs[input.sourceOutputIndex].satoshis);
                ...
                lockingScript || (lockingScript = (_d = input.sourceTransaction) === null || _d === void 0 ? void 0 : _d.outputs[input.sourceOutputIndex].lockingScript);
                ...
                const preimage = index_js_2.TransactionSignature.format({
                    ...
                    inputIndex,
                    outputs: tx.outputs,
                    inputSequence: (_e = input.sequence) !== null && _e !== void 0 ? _e : 0xffffffff,
