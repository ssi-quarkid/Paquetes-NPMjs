...
class Peer {
    ...
    async processInitialResponse(message) {
        ...
        const dataToVerify = Utils.toArray(((_a = peerSession.sessionNonce) !== null && _a !== void 0 ? _a : '') + ((_b = message.initialNonce) !== null && _b !== void 0 ? _b : ''), 'base64');
        ...
        if (((_f = (_e = this.certificatesToRequest) === null || _e === void 0 ? void 0 : _e.certifiers) === null || _f === void 0 ? void 0 : _f.length) > 0 &&
            ((_g = message.certificates) === null || _g === void 0 ? void 0 : _g.length) > 0) {
    ...
    async processCertificateRequest(message) {
        ...
        const { valid } = await this.wallet.verifySignature({
            ...
            signature: message.signature,
            protocolID: [2, 'auth message signature'],
            keyID: `${(_a = message.nonce) !== null && _a !== void 0 ? _a : ''} ${(_b = peerSession.sessionNonce) !== null && _b !== void 0 ? _b : ''}`,
            counterparty: peerSession.peerIdentityKey
        });
        if (!valid) {
    ...
    async processCertificateResponse(message) {
        ...
        this.onCertificatesReceivedCallbacks.forEach(cb => {
            var _a;
            cb(message.identityKey, (_a = message.certificates) !== null && _a !== void 0 ? _a : []);
        });
        peerSession.lastUpdate = Date.now();
        this.sessionManager.updateSession(peerSession);
    }
    ...
    async processGeneralMessage(message) {
        ...
        this.onGeneralMessageReceivedCallbacks.forEach(cb => {
            var _a;
            cb(message.identityKey, (_a = message.payload) !== null && _a !== void 0 ? _a : []);
        });
    }
}
exports.Peer = Peer;
