...
class TransactionSignature extends Signature_js_1.default {
    static format(params) {
        ...
        const getSequenceHash = () => {
            ...
            const writer = new utils_js_1.Writer();
            for (const input of inputs) {
                const sequence = (_a = input.sequence) !== null && _a !== void 0 ? _a : 0xffffffff; // Default to max sequence number
        ...
        function getOutputsHash(outputIndex) {
            ...
            if (typeof outputIndex === 'undefined') {
                for (const output of params.outputs) {
                    const satoshis = (_a = output.satoshis) !== null && _a !== void 0 ? _a : 0; // Default to 0 if undefined
                    writer.writeUInt64LE(satoshis);
                    const script = (_c = (_b = output.lockingScript) === null || _b === void 0 ? void 0 : _b.toBinary()) !== null && _c !== void 0 ? _c : [];
                ...
                const satoshis = (_d = output.satoshis) !== null && _d !== void 0 ? _d : 0; // Default to 0 if undefined
                writer.writeUInt64LE(satoshis);
                const script = (_f = (_e = output.lockingScript) === null || _e === void 0 ? void 0 : _e.toBinary()) !== null && _f !== void 0 ? _f : [];
                writer.writeVarIntNum(script.length);
                writer.write(script);
            }
            const buf = writer.toArray();
